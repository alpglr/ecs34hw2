...
TEST(DSVReader, ReadTest){
 ...
 TEST(DSVReader, WriteReadTest2)
 {
    ...
    EXPECT_EQ(output1[2], "a \"nother\" example");   //when there is two double quotes, only return 1.
    EXPECT_EQ(output1[3], "string");                   // only read in a double quote as part of the cell if it is two consecutive double quotes.
